...
image_files = dir(fullfile(image_folder, '23-17.jpg')); % Obtendo arquivos de imagem

% Número de clusters para K-means
num_clusters = 5; % Pode ajustar dependendo do cenário
...
for i = 1:length(image_files)
    ...
    img = imread(img_path);
    filteredImage = gaussianLowPassFilterRGB(img, [5 5], 4);
